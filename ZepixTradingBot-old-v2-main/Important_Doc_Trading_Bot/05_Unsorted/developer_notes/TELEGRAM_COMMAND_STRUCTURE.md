...
└─ Button: "⚙️ Set SL"
   ├─ If Mode SL-1.1:
   │  ├─ Select Logic: [LOGIC1, LOGIC2, LOGIC3]
   │  └─ Enter Value: "Type value (e.g., 20)"
   ├─ If Mode SL-2.1:
   │  └─ Enter Value: "Type value (e.g., 10)"
   └─ Confirmation
      └─ Execute: handle_set_profit_sl(logic, value)
```
**Steps:** MAIN MENU → PROFIT → SET SL → [LOGIC] → VALUE → CONFIRM  
**Parameters:** logic (required for SL-1.1), value  
...
### 11. Reverse Shield & Fine-Tune Commands (v3.0)

| Command | Description | Usage |
| :--- | :--- | :--- |
| `/shield` | Control Reverse Shield System v3.0 | `/shield on`, `/shield off`, `/shield status` |
| `/fine_tune` | Open Fine-Tune Menu | `/fine_tune` |
| `/profit_protection` | Configure Profit Protection | `/profit_protection` |
| `/sl_reduction` | Configure SL Reduction | `/sl_reduction` |
| `/recovery_windows` | View Recovery Windows | `/recovery_windows` |
| `/autonomous_status` | View Autonomous Dashboard | `/autonomous_status` |
| `/dashboard` | Open Interactive Dashboard | `/dashboard` |

#### 11.1 `/shield` - Reverse Shield Control
*   **Description:** Controls the Reverse Shield v3.0 system.
*   **Parameters:** `on`, `off`, `status`
*   **Handler:** `handle_shield_command`
*   **Example:** `/shield on` -> Enables shield system.

#### 11.2 `/fine_tune` - Fine-Tune Menu
*   **Description:** Opens the interactive Fine-Tune menu.
*   **Handler:** `handle_fine_tune`

#### 11.3 `/dashboard` - Interactive Dashboard
*   **Description:** Displays real-time PnL and controls.
*   **Handler:** `handle_dashboard`

### 12. Timeframe Logic Control (v3.0)

| Command | Description | Usage |
| :--- | :--- | :--- |
| `/toggle_timeframe` | Enable/Disable Timeframe Specific Logic | `/toggle_timeframe` |
| `/view_logic_settings` | View current logic config | `/view_logic_settings` |
| `/reset_timeframe_default` | Reset logic settings to default | `/reset_timeframe_default` |

#### 12.1 `/toggle_timeframe`
*   **Handler:** `handle_toggle_timeframe`
*   **Function:** Enables specialized logic for different timeframes.

#### 12.2 `/view_logic_settings`
*   **Handler:** `handle_view_logic_settings`
*   **Function:** Shows current logic configuration.
...
### Total Command Count: **91 Commands**
...
9. 📈 Profit Booking: **15 commands**
10. 🔍 Diagnostics & Health: **15 commands**
11. 🛡️ Reverse Shield & Fine-Tune: **7 commands** (🆕 New v3.0)
12. ⏱️ Timeframe Logic: **3 commands** (🆕 New v3.0)
