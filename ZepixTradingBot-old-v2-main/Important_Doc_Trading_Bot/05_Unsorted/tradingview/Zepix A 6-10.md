...
// © Licensed by Zepix
// PART B: Symbols 6-10 (VISUALS FIXED & ACCURATE)

//@version=6
indicator("Zepix Part B (6-10)", overlay=true, max_lines_count=100, max_labels_count=100)
...
// --- SYMBOLS 6-10 ---
s06 = input.symbol("AUDUSD", "Sym 6", group="WATCHLIST B")
s07 = input.symbol("NZDUSD", "Sym 7", group="WATCHLIST B")
s08 = input.symbol("EURJPY", "Sym 8", group="WATCHLIST B")
s09 = input.symbol("GBPJPY", "Sym 9", group="WATCHLIST B")
s10 = input.symbol("AUDJPY", "Sym 10", group="WATCHLIST B")
...
// --- TABLE INIT (Lower) ---
var table dash = table.new(position.middle_right, 5, 6, border_width = 1, bgcolor = color.new(color.black, 40))
if barstate.islast
    hCol = #673AB7
    table.cell(dash, 0, 0, "SYM (B)", text_color=color.white, bgcolor=hCol)
